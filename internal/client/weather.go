...
func (c *WeatherClient) GeocodeCity(ctx context.Context, city string) (string, float64, float64, error) {
	u := c.GeocodingURL(city)
	...
	return geoResp.Results[0].Name, geoResp.Results[0].Latitude, geoResp.Results[0].Longitude, nil
}
